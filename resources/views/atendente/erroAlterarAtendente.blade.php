        ...
        <form action="/alterarAtendente/{{$id}}" method="POST">
            ...
            <div class="d-flex flex-row justify-content-evenly">
                <div class="d-flex flex-column">
                    ...
                    <input type="text" class="form-control" name="nome_atendente" value="{{$dadosAlteracao->nome_atendente}}" pattern="[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ]{1,60}[0-9]{0,10}[\w\s]{0,}" required>
                </div>
                <div class="d-flex flex-column">
                    <label class="form-label">Sobrenome</label>
                    <input type="text" class="form-control" name="sobrenome_atendente" value="{{$dadosAlteracao->sobrenome_atendente}}" pattern="[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ]{1,60}[0-9]{0,10}[\w\s]{0,}" required>
                </div>
            </div>
            ...
            <div class="d-flex flex-row justify-content-evenly mt-5">
              ...
              @if (isset($dadosAlteracao->numero_celular))
                <div class="d-flex flex-column">
                  ...
                  <input type="text" class="form-control" name="numero_celular" value="{{$dadosAlteracao->numero_celular}}" pattern="[9]{1}[0-9]{8}">
                </div>
              @else
                <div class="d-flex flex-column">
                  <label class="form-label">Celular</label>
                  <input type="text" class="form-control" name="numero_celular" pattern="[9]{1}[0-9]{8}">
                </div>
              @endif
            </div>
            <div class="d-flex flex-row justify-content-evenly mt-5">
